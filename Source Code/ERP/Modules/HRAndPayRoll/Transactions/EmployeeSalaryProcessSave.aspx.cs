    ...
    public partial class EmployeeSalaryProcessSave : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    SessionHelper.MessageSession = String.Format(CommonHelper.GetLanguageLabel("SaveSuccessMsg"), CommonHelper.GetLanguageLabel("EmployeePaidSalary"));
                ...
                {
                    ScriptManager.RegisterStartupScript(this, typeof(Page), "AlreadyExistsMsg", " $(document).ready(function() {Common.ShowToastrMessage(Common.Variable.Warning, Common.Variable.Warning, '" + String.Format(CommonHelper.GetLanguageLabel(_Result.Message), CommonHelper.GetLanguageLabel("EmployeeSalaryProcess")) + "');});", true);
                }
            }
        ...
        private void FillDefaultValues()
        {
            try
            {
                ...
                {
                    btnSave.Visible = false;
                    ScriptManager.RegisterStartupScript(this, typeof(Page), "WarningMsg", " $(document).ready(function() {Common.ShowToastrMessage(Common.Variable.Warning, Common.Variable.Warning, '" + CommonHelper.GetLanguageLabel("NoAnyAttendanceMsg") + "');});", true);
                }
