    ...
    public partial class EmployeeSave : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _Employee.PFNo = txtPFNumber.Text.Trim();
                ...
                if (_Result.IsSuccess)
                {
                    ...
                    SessionHelper.MessageSession = String.Format(CommonHelper.GetLanguageLabel("SaveSuccessMsg"), CommonHelper.GetLanguageLabel("Employee"));
                ...
                {
                    ScriptManager.RegisterStartupScript(this, typeof(Page), "AlreadyExistsMsg", " $(document).ready(function() {Common.ShowToastrMessage(Common.Variable.Warning, Common.Variable.Warning, '" + String.Format(CommonHelper.GetLanguageLabel(_Result.Message), CommonHelper.GetLanguageLabel("EmployeeEmail")) + "');});", true);
                }
            }
        ...
        private void FillEmployeeType()
        {
            ...
            ddlEmployeeType.Items.Insert(0, new ListItem() { Text = CommonHelper.GetLanguageLabel("Select"), Value = "" });
        }
        ...
        private void FillDepartment()
        {
            ...
            ddlDepartment.Items.Insert(0, new ListItem() { Text = CommonHelper.GetLanguageLabel("Select"), Value = "" });
        }
        ...
        private void FillDesignation()
        {
            ...
            ddlDesignation.Items.Insert(0, new ListItem() { Text = CommonHelper.GetLanguageLabel("Select"), Value = "" });
        }
        ...
        private void FillEmployeeGrade()
        {
            ...
            ddlEmployeeGrade.Items.Insert(0, new ListItem() { Text = CommonHelper.GetLanguageLabel("Select"), Value = "" });
        }
        ...
        private void FillShift()
        {
            ...
            ddlShift.Items.Insert(0, new ListItem() { Text = CommonHelper.GetLanguageLabel("Select"), Value = "" });
        }
        ...
        private void FillControls(Guid p_Id)
        {
            try
            {
                ...
                if (_Result.IsSuccess)
                {
                    ...
                    txtPFNumber.Text = _Result.Data.PFNo;
