    ...
    public partial class ApplyLeaveApplication : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    SessionHelper.MessageSession = String.Format(CommonHelper.GetLanguageLabel("SaveSuccessMsg"), CommonHelper.GetLanguageLabel("ApplyLeaveApplication"));
                    ...
                    Result<List<String>> _ResultEmail = _IUserService.GetAllReceiveApproveEmail();
                ...
                {
                    ScriptManager.RegisterStartupScript(this, typeof(Page), "AlreadyExistsMsg", " $(document).ready(function() {Common.ShowToastrMessage(Common.Variable.Warning, Common.Variable.Warning, '" + String.Format(CommonHelper.GetLanguageLabel(_Result.Message), CommonHelper.GetLanguageLabel("ApplyLeaveApplication")) + "');});", true);
                }
            }
        ...
        private void FillLeaveCategory()
        {
            ...
            ddlLeaveCategory.Items.Insert(0, new ListItem() { Text = CommonHelper.GetLanguageLabel("Select"), Value = "" });
        }
