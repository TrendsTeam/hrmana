<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/Main.Master" AutoEventWireup="true"
    CodeBehind="DepartmentSave.aspx.cs" Inherits="ERP.Modules.HRAndPayRoll.Masters.DepartmentSave" %>
...
<asp:Content ID="cBreadCrumb" ContentPlaceHolderID="cphBreadCrumb" runat="server">
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
         ...
         <li class="nav-item d-none d-sm-inline-block">
            <a href="javascript:;" title="Save Department" class="nav-link"><asp:Literal runat="server" Text="<%$Resources:GlobalStrings, SaveDepartment %>"></asp:Literal></a>
        </li>
    </ul>
</asp:Content>
<asp:Content ID="cBody" ContentPlaceHolderID="cphBody" runat="server">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h3><asp:Literal runat="server" Text="<%$Resources:GlobalStrings, SaveDepartment %>"></asp:Literal></h3>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header border-transparent">
                            <h3 class="card-title"><asp:Literal runat="server" Text="<%$Resources:GlobalStrings, SaveDepartment %>"></asp:Literal></h3>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <asp:TextBox ID="txtDepartment" MaxLength="100" runat="server" CssClass="form-control"></asp:TextBox>
                        ...
                        <div class="form-actions">
                            <a href="/Modules/HRAndPayRoll/Masters/DepartmentList.aspx" class="btn pull-right"><asp:Literal runat="server" Text="<%$Resources:GlobalStrings, Cancel %>"></asp:Literal>
                            </a>
