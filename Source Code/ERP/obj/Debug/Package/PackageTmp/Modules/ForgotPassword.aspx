...
<head runat="server">
    <title><asp:Literal runat="server" Text="<%$Resources:GlobalStrings, Forgot_Password %>"></asp:Literal></title>
    <meta charset="UTF-8" />
      ...
      <div class="card">
            <div class="card-body login-card-body">
                <form id="frmForgotPassword" runat="server">
                      <p class="login-box-msg"><asp:Literal runat="server" Text="<%$Resources:GlobalStrings, ForgotPasswordTitle %>"></asp:Literal></p>
                    ...
                    <div class="form-btn-actions">
                        <asp:LinkButton CssClass="submit btn btn-primary pull-left" ID="btnSendLink" runat="server" OnClick="btnSendLink_Click"><asp:Literal runat="server" Text="<%$Resources:GlobalStrings, SendLink %>"></asp:Literal> <i class="fa fa-angle-right"></i></asp:LinkButton>
