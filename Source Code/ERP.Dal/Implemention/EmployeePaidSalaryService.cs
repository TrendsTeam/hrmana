...
namespace ERP.Dal.Implemention
{
    public class EmployeePaidSalaryService : IEmployeePaidSalaryService
    {
        ...
        public Result<List<EmployeePaidSalarys>> GetEmployeeCompletedPaidSalaryByMonth(string p_Month, int p_Year)
        {
        ...
        public Result<List<EmployeePaidSalarys>> GetEmployeePendingSalaryByMonth(string p_Month, int p_IntMonth, int p_Year)
        {
            Result<List<EmployeePaidSalarys>> _Result = new Result<List<EmployeePaidSalarys>>();
            ...
            try
            {
                ...
                using (var dbContext = new ERPEntities())
                {
                    ...
                    var _Query = from e in dbContext.EmployeeMasters
                                 ...
                                 where e.IsActive == true && e.JoinDate < _MonthYearDate && e.IsLeave == false && es.IsActive == true && !e.EmployeePaidSalaries.Where(eps => eps.IsActive == true && eps.IsPaid == true && eps.Month == p_Month && eps.Year == p_Year).Select(eps => eps.EmployeeId).Contains(e.EmployeeID)
                                 select new EmployeePaidSalarys
                                 {
