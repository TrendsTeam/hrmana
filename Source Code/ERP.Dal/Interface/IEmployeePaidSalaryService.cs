...
namespace ERP.Dal.Interface
{
    public interface IEmployeePaidSalaryService
    {
        ...
        Result<List<EmployeePaidSalarys>> GetEmployeeCompletedPaidSalaryByMonth(string p_Month, int p_Year);

        Result<List<EmployeePaidSalarys>> GetEmployeePendingSalaryByMonth(string p_Month,int p_IntMonth, int p_Year);
